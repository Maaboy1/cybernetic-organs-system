...
public class Patient {
    ...
    private com.cybernetic.Organ[] installedOrgans;
    ...
    public Patient(String name, int age, String medicalHistory) {
        ...
        this.installedOrgans = new com.cybernetic.Organ[5];
        this.organCount = 0;
    }
    ...
    public String addOrgan(com.cybernetic.Organ organ) {
    ...
    public List<com.cybernetic.Organ> getOrganList() {
        List<com.cybernetic.Organ> organList = new ArrayList<>();
